<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Link Classificações -->
                    <x-nav-link :href="route('classificacoes.index')" :active="request()->routeIs('classificacoes.*')">
                        {{ __('Classificações') }}
                    </x-nav-link>
                    ...
                    <!-- Link Dados -->
                    <x-nav-link :href="route('dados.index')" :active="request()->routeIs('dados.*')">
                        {{ __('Configurações') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- Link Ajuda -->
                        <x-dropdown-link :href="'https://drive.google.com/drive/folders/1JC7EzBqwC7_KYH2cJKwg0jtvg_3PNfUg?usp=drive_link'" target="_blank">
                            {{ __('Ajuda') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Link Editoras (mobile) -->
            <x-responsive-nav-link :href="route('editoras.index')" :active="request()->routeIs('editoras.*')">
                {{ __('Editoras') }}
            </x-responsive-nav-link>

             <!-- Link Classificações (mobile) -->
             <x-responsive-nav-link :href="route('classificacoes.index')" :active="request()->routeIs('classificacoes.*')">
                {{ __('Classificações') }}
            </x-responsive-nav-link>

            <!-- Link Dados (mobile) -->
            <x-responsive-nav-link :href="route('dados.index')" :active="request()->routeIs('dados.*')">
                {{ __('Configurações') }}
            </x-responsive-nav-link>

            <!-- Link Relatorios (mobile) -->
            <x-responsive-nav-link :href="route('relatorios.livros_html')" :active="request()->routeIs('relatorios.*')">
                {{ __('Relatorios') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <x-responsive-nav-link :href="route('users.index')">
                ...
                <!-- Link Ajuda (mobile) -->
                <x-responsive-nav-link :href="'https://drive.google.com/drive/folders/1JC7EzBqwC7_KYH2cJKwg0jtvg_3PNfUg?usp=drive_link'" target="_blank">
                    {{ __('Ajuda') }}
                </x-responsive-nav-link>
